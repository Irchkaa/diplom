...
<li><a href="index.php">Главная</a></li>
		<li><a href="history.php">История создания</li></a>
			<li><a href="virt.php">Виртуальная эксурсия</a></li>
...
<div id="contenter">
			<div class="border_box">
				<div class="box_skitter box_skitter_large">
					<ul>
						<li><img src="images/м1.jpg" class="circles" /></li>
						<li><img src="images/м2.jpg" class="circlesInside" /></li>
						<li><img src="images/м3.jpg" class="circlesRotate" /></li>
						<li><img src="images/м4.jpg" class="cubeShow" /></li>	
					</ul>
				</div>
			</div>
		</div>
 ...
 <h2 align="center">Зона мультимедийного обслуживания </h2></br>
 <p align="center">Зона мультимедийного обслуживания работает с мультимедиа продукцией (CD, DVD, Blue-ray, 3D) и выполняет: 
 выдачу и индивидуальный просмотр, фрагментарный видеопоказ в образовательных и культурных целях, Интернет, wi-fi, выдача электронных книг «Литрес», 
 базы данных, электронный каталог библиотеки. Зона мультимедийного обслуживания размещает 15-20 посетителей. <p align="center"></p>
 </p>
